...
import cn.bitflash.common.AESTokenUtil;
import cn.bitflash.common.Common;
import cn.bitflash.common.utils.R;
import cn.bitflash.common.utils.RedisUtils;
...
@RequestMapping("/api")
@Api(tags = "获取用户交易接口")
public class ApiUserTradeController2 {

    private final Logger logger = LoggerFactory.getLogger(ApiUserTradeController2.class);
